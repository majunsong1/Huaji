...
cc._RF.push(module, '10b6aEqXrhGZoW2XWku0cO5', 'Game', __filename);
// NewScript/Game.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        // 获取地平面的 y 轴坐标
        this.groundY = this.ground.y + this.ground.height / 2; //旋转时则无此值
        // 初始化计时器
        this.timer = 0;
        this.starDuration = 0;
        // 生成一个新的星星
    ...
    gainScore: function gainScore() {
        ...
        this.scoreDisplay.string = 'FenShu: ' + this.score.toString();
        cc.audioEngine.playEffect(this.scoreAudio, false);
    },

    gameOver: function gameOver() {
        this.player.stopAllActions(); //停止 player 节点的跳跃动作
        this.scoreDisplay.string = 'You Fool!';
    }
